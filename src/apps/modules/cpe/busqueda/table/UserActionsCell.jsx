        ...
        <>
            ...
            >
                ...
                <div className='menu-item px-3'>
                    ...
                    {
                        cpe.urlPdf && <a className='menu-link px-3' href={cpe.urlPdf} target="_blank" title='Descargar XML' rel="noreferrer">
                            <KTSVG path='/media/icons/duotune/fe/xml.svg' className='svg-icon-3' />
                    ...
                    {
                        cpe.urlCdr && <a className='menu-link px-3' href={cpe.urlCdr} target="_blank" title='Descargar XML' rel="noreferrer">
                    ...
                    {
                        cpe.urlPdf && <Link to={`/visorpdf/${cpe.urlPdf?.substring(cpe.urlPdf.lastIndexOf("/") + 1)}`}
                            target="_blank"
