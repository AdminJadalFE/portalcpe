  ...
  return (
    <div className='card mb-2'>
      <div className='card-body pt-1 pb-0'> 
            ...
            <Row className="mb-3">
                <Col xs={6}>
                    <Form.Label htmlFor="pesoBrutoTotal" className="mb-2">Peso Bruto Total</Form.Label>
                    <Form.Group controlId="pesoBrutoTotal">
                    <Form.Control size="sm" type="text" placeholder="Ingrese el peso bruto total" onChange={setPesoBrutoTotal}/>
                    </Form.Group>
                </Col>
                <Col xs={6}>
                    <Form.Label htmlFor="numeroBultos" className="mb-2">Número de Bultos</Form.Label>
                    <Form.Group controlId="numeroBultos">
                    <Form.Control size="sm" type="number" placeholder="Ingrese el número de bultos" onChange={setNumeroBultos}/>
                    </Form.Group>
                </Col>
            </Row>
            ...
            <Row className="mb-3">
                <Col xs={9}>
                    <Form.Label htmlFor="direccionPartida" className="mb-2">Dirección de Partida</Form.Label>
                    <Form.Group controlId="direccionPartida">
                    <Form.Control size="sm" type="text" placeholder="Ingrese la dirección de partida" onChange={setDireccionPartida}/>
                    </Form.Group>
                </Col>
                <Col xs={3}>
                    <Form.Label htmlFor="direccionPartidaUbigeo" className="mb-2">Ubigeo</Form.Label>
                    <Form.Group controlId="direccionPartidaUbigeo">
                    <Form.Control size="sm" type="text" placeholder="Ingrese el Ubigeo de la dirección de partida" onChange={setDireccionPartidaUbigeo}/>
                    </Form.Group>
                </Col>
            </Row>
            ...
            <Row className="mb-3">
                <Col xs={9}>
                    <Form.Label htmlFor="direccionLlegada" className="mb-2">Dirección de Llegada</Form.Label>
                    <Form.Group controlId="direccionLlegada">
                    <Form.Control size="sm" type="text" placeholder="Ingrese la dirección de partida" onChange={setDireccionLlegada}/>
                    </Form.Group>
                </Col>
                <Col xs={3}>
                    <Form.Label htmlFor="direccionLlegadaUbigeo" className="mb-2">Ubigeo</Form.Label>
                    <Form.Group controlId="direccionLlegadaUbigeo">
                    <Form.Control size="sm" type="text" placeholder="Ingrese el Ubigeo de la dirección de partida" onChange={setDireccionLlegadaUbigeo}/>
                    </Form.Group>
                </Col>
            </Row>
