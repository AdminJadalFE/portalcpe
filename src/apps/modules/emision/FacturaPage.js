...
function MyVerticallyCenteredModal(props) {
  ...
  const { datosCpe,datosReceptor,datosItem, datosTotales, datosAdicionales, datosContingencia, datosDocRel, datosFormaPago, 
    CleanDatosCpe, CleanDatosReceptor, CleanItem, CleanDatosTotales, CleanDatosAdicionales, CleanDatosContingencia, CleanFormaPago, CleanDocRel} = useEmision();
