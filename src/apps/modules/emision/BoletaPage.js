...
function MyVerticallyCenteredModal(props) {
  ...
  const { datosCpe,datosReceptor,datosItem, datosTotales, datosAdicionales, datosContingencia, datosDocRel, 
    CleanDatosCpe, CleanDatosReceptor, CleanItem, CleanDatosTotales, CleanDatosAdicionales, CleanDatosContingencia, CleanDocRel} = useEmision();
