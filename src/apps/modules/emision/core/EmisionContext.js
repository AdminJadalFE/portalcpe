...
const EmisionProvider = ({ children }) => {
  ...
  return (
    <EmisionContext.Provider
      value={{
        setCpeDatosInicial, setCpeDatos, CleanDatosCpe, setReceptorDatos, setTransporteDatos, setEnvioDatos, CleanDatosReceptor, CleanDatosTransporte, CleanDatosEnvio, setReferenciaDatos, CleanDatosReferencia, setTotales, CleanDatosTotales, setContingenciaDatos, CleanDatosContingencia, setAdicionalesDatos, CleanDatosAdicionales,
